...
import { LogOut, LayoutDashboard, Users, Megaphone, User, BarChart3, MessageSquare } from "lucide-react";
...
export default function Sidebar() {
  ...
  const items = navLoaded ? navItems : [
    ...
    { title: "Messages", href: "/team-leader/messages", icon: MessageSquare, badgeKey: "messages" as const },
    { title: "Group Chat", href: "/team-leader/group-chat", icon: Megaphone, badgeKey: "groupChat" as const },
    { title: "Reports", href: "/team-leader/reports", icon: BarChart3 },
    { title: "Announcements", href: "/team-leader/announcements", icon: Megaphone, badgeKey: "announcements" as const },
    { title: "Profile", href: "/team-leader/profile", icon: User },
  ];
      ...
      <div className="relative shrink-0 overflow-hidden border-b border-[#D4AF37]/20 bg-gradient-to-b from-[#1c1c1c] to-[#161616] px-6 py-7">
        ...
        <div className="relative flex items-center gap-3">
          ...
          <div className="min-w-0">
            ...
            <p className="mt-0.5 truncate text-xs font-medium uppercase tracking-wider text-zinc-500">Team Leader</p>
          </div>
        </div>
      </div>
