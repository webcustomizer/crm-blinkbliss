...
import { Mail, Phone, ShieldCheck, Edit3, Check, X, User } from "lucide-react";
...
export default function AdminPersonalInfoCard({ profile, onProfileUpdated }: AdminPersonalInfoCardProps) {
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-4 rounded-2xl border border-white/10 bg-black/20 p-4">
          ...
          <div className="min-w-0">
            ...
            <p className="mt-1 break-all text-sm font-medium text-white">{profile.email}</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4 rounded-2xl border border-white/10 bg-black/20 p-4">
          ...
          <div className="min-w-0 flex-1">
            ...
            {editing ? (
              ...
              <p className="mt-1 text-sm font-medium text-white">{profile.phone || "Not provided"}</p>
            )}
          </div>
        </div>
